...
export default function InvestmentUtilities() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-purple-50 to-blue-50 py-16" data-testid="section-investment-guide">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-6" data-testid="text-guide-title">
                Hướng Dẫn Đầu Tư Với HHDcoin
              </h2>
            ...
            <div className="space-y-8">
              {investmentGuideSteps.map((step, index) => {
                ...
                return (
                  <Card key={index} className="relative overflow-hidden hover:shadow-lg transition-shadow" data-testid={`card-step-${index + 1}`}>
                    ...
                    <CardContent className="pl-8">
                      ...
                      {index < investmentGuideSteps.length - 1 && (
            ...
            <div className="text-center mt-16">
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <h3 className="text-3xl font-bold mb-6" data-testid="text-ready-title">
