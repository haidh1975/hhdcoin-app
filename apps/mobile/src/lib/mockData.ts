...
export const mockSentimentData: SentimentData[] = [
  {
    ...
    newsSummary:
      'Bitcoin duy trì đà tăng với sự ủng hộ từ các tổ chức lớn. ETF spot Bitcoin tiếp tục ghi nhận dòng tiền vào ổn định.',
  ...
  },
  {
    ...
    newsSummary:
      'Ethereum tiếp tục phát triển hệ sinh thái Layer 2. EIP mới đang được cộng đồng xem xét.',
    updatedAt: new Date().toISOString(),
  },
  {
    coin: 'Solana',
    ...
    newsSummary:
      'Solana tiếp tục thu hút developers với hiệu suất cao và phí thấp. Meme coin ecosystem bùng nổ.',
    updatedAt: new Date().toISOString(),
  },
  {
    coin: 'BNB',
    ...
    newsSummary:
      'BNB Chain duy trì vị thế ổn định trong thị trường. Binance tiếp tục mở rộng dịch vụ toàn cầu.',
    updatedAt: new Date().toISOString(),
  },
];
